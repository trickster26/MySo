    ...
    <section id="minimal-statistics">
        <div class="row">
            ...
            <div class="col-1 mt-3 mb-1">
                <a href="/templates/add_address.php"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="green" class="bi bi-plus-circle" viewBox="0 0 16 16">
                            ...
                            <div class="card-body">
                                <div class="media d-flex">
                                    ...
                                    <div class="media-body">
                                        <h2><strong><?php echo $address['address_type']; ?></strong></h2>
                                        ...
                                        <div class="mt-3">
                                            <span class="col-6">
                                            <a href="<?php URL ?>/templates/edit-address.php?id=<?php echo $address['id']; ?>" >
                                            ...
                                            <a href="<?php URL ?>/templates/delete-address.php?id=<?php echo $address['id']; ?>">
            ...
            <ul class="pagination justify-content-center">
                <?php if ($totalPages > 1) { ?>
                    <?php if ($currentPage > 1) { ?>
                        <li class="page-item">
                            <a class="page-link" href="<?php URL ?>/templates/addresses.php?page=<?php echo $currentPage - 1; ?>">Previous</a>
                        </li>
                    <?php } ?>
                    <?php for ($i = 1; $i <= $totalPages; $i++) { ?>
                        <li class="page-item <?php echo ($i === $currentPage) ? 'active' : ''; ?>">
                            <a class="page-link" href="<?php URL ?>/templates/addresses.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                        </li>
                    <?php } ?>
                    <?php if ($currentPage < $totalPages) { ?>
                        <li class="page-item ">
                            <a class="page-link" href="<?php URL ?>/templates/addresses.php?page=<?php echo $currentPage + 1; ?>">Next</a>
                        </li>
                    <?php } ?>
                <?php } ?>
            </ul>
