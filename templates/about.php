...
<section class="about-section">
        <div class="container">
            <div class="row">                
                <div class="content-column col-lg-6 col-md-12 col-sm-12 order-2">
                    <div class="inner-column">
                        <div style="position:relative; z-index: 1; margin-bottom:60px;" class="sec-title">
                            <span class="title">About transition</span>
                            <h2>We are Creative Tech Enthusiast working since 2015</h2>
                        </div>
                        <div class="text">I am Anu Kumar works at Css3 Transition since last 3 years. We are here to provide touch notch solution for your website or web application that helps you to make your website look attractive & efficient in handling by creating usefull plugins thats you need.</div>
                      <div class="text">
           ...
           <div style="position:relative; z-index: 1; margin-bottom:60px; display: block;
font-size: 18px;
line-height: 24px;
color: #00aeef;
font-weight: 500;
...
color: #00aeef;
font-weight: 500;
margin-bottom: 15px;" class="sec-title">
